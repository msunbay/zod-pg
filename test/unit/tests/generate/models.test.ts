  ...
  describe('createTableModel', () => {
    it('should create a basic table model with default configuration', async () => {
      ...
      expect(result).toEqual({
        ...
        tableReadBaseSchemaName: 'UsersTableBaseSchema',
        tableInsertBaseSchemaName: 'UsersTableInsertBaseSchema',
        ...
        tableReadBaseRecordName: 'UserBaseRecord',
        tableInsertBaseRecordName: 'UserInsertBaseRecord',
        tableUpdateBaseRecordName: 'UserUpdateBaseRecord',
        tableReadRecordName: 'UserRecord',
        tableUpdateRecordName: 'UserUpdateRecord',
        tableReadTransformName: 'transformUserBaseRecord',
        tableInsertTransformName: 'transformUserInsertBaseRecord',
        tableUpdateTransformName: 'transformUserUpdateBaseRecord',
        jsonSchemaImportLocation: undefined,
